...
public class GrasshopperInUnity : MonoBehaviour
{
  ...
  void Update()
  {
    ...
    var pt1 = GameObject.Find("BoxPoint").transform.position.ToRhino();
    using (var args = new Rhino.Runtime.NamedParametersEventArgs())
    {
      args.Set("point_box", new Rhino.Geometry.Point(pt1));
      Rhino.Runtime.HostUtils.ExecuteNamedCallback("ToGrasshopper2", args);
    }
